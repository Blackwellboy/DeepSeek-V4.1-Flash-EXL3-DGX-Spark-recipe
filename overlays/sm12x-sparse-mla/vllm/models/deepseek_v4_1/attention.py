...
class DeepseekV4Attention(nn.Module, AttentionLayerBase, ABC):
    ...
    def __init__(
        ...
        self.swa_cache_layer = DeepseekV4SWACache(
            ...
            # Adapted from tonyd2wild/DeepSeek-V4.1-Flash-vLLM-DGX-Spark@fc725ec
            # (Tech2Wild/Kai SM12x): FlashInfer SM120 sparse-MLA uses 64-token pages.
    ...
    def get_kv_cache_spec(self, vllm_config: VllmConfig) -> KVCacheSpec | None:
        ...
        # Adapted from tonyd2wild/...@fc725ec (Tech2Wild/Kai SM12x):
        # SM120 FlashInfer sparse-MLA kernels use 64-STATE compressed pages.
...
class DeepseekV4IndexerSM12xBackend(DeepseekV4IndexerBackend):
    """Adapted from tonyd2wild/...@fc725ec (Tech2Wild): SM12x indexer pages
    hold 64 states (64 tokens at ratio 1, 128 at ratio 2)."""
...
class DeepseekV4IndexerCache(torch.nn.Module, AttentionLayerBase):
    ...
    def get_kv_cache_spec(self, vllm_config: VllmConfig) -> KVCacheSpec:
        ...
        # Adapted from tonyd2wild/...@fc725ec: DeepGEMM needs 32/64 states/block.
